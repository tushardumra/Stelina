...
export const AdminDashboard = () => {
  ...
  const fetchCustomers = async () => {
    try {
      const res = await fetch("http://localhost:9000/api/customers-info");
  ...
  const fetchCategories = async () => {
    try {
      const useApi = await fetch("http://localhost:9000/api/category-count", {
        method: "Get",
      });
      if (useApi.ok) {
  ...
  const fetchProducts = async () => {
    try {
      const useApi = await fetch("http://localhost:9000/api/products-count", {
        method: "Get",
      });
      if (useApi.ok) {
        const resp = await useApi.json();
  ...
  const fetchPayType = async () => {
    try {
      const useApi = await fetch("http://localhost:9000/api/paytype", {
        method: "Get",
      });
      if (useApi.ok) {
        const resp = await useApi.json();
  ...
  const fetchOrders = async () => {
    try {
      const useApi = await fetch("http://localhost:9000/api/orders-over-time", {
        method: "Get",
      });
      if (useApi.ok) {
        const resp = await useApi.json();
