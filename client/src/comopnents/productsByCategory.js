              ...
              <div class="site-main">
                ...
                {/* <div class="shop-top-control">
                  ...
                  <div class="grid-view-mode">
                    <div class="inner">
                      <Link to="/productsList" class="modes-mode mode-list">
                        <span></span>
                        <span></span>
                      </Link>
                      <a
                        href="gridproducts.html"
                        class="modes-mode mode-grid  active"
                      >
                        <span></span>
                        <span></span>
                        <span></span>
                      ...
                      <div class="product-inner equal-element">
                        ...
                        <div class="product-thumb">
                          <div class="thumb-inner">
                            <Link to={`/productDetailedView?id=${product._id}&cid=${pId}`}>
                              <img
                                // src={`/assets/uploadProducts/${product.ProductName + ".jpg"}`}
                  ...
                  <div class="widget widget-brand">
                    ...
                    <ul class="list-brand">
                      <li>
                        ...
                        <label for="cb7" class="label-text">
                          New Arrivals
                        </label>
                      </li>
                      <li>
                        <input id="cb8" type="checkbox" />
                        <label for="cb8" class="label-text">
                          Dining
                        </label>
                      </li>
                      <li>
                        <input id="cb9" type="checkbox" />
                        <label for="cb9" class="label-text">
                          Desks
                        </label>
                      </li>
                      <li>
                        <input id="cb10" type="checkbox" />
                        <label for="cb10" class="label-text">
                          Accents
                        </label>
                      </li>
                      <li>
                        <input id="cb11" type="checkbox" />
                        <label for="cb11" class="label-text">
                          Accessories
                        </label>
                      </li>
                      <li>
                        <input id="cb12" type="checkbox" />
                        <label for="cb12" class="label-text">
                          Tables
                        </label>
                      </li>
                    </ul>
                  ...
                  <div class="widget widget_filter_size">
                    ...
                    <ul class="list-brand">
                      <li>
                        ...
                        <label for="cb13" class="label-text">
                          14.0 mm
                        </label>
                      </li>
                      <li>
                        <input id="cb14" type="checkbox" />
                        <label for="cb14" class="label-text">
                          14.4 mm
                        </label>
                      </li>
                      <li>
                        <input id="cb15" type="checkbox" />
                        <label for="cb15" class="label-text">
                          14.8 mm
                        </label>
                      </li>
                      <li>
                        <input id="cb16" type="checkbox" />
                        <label for="cb16" class="label-text">
                          15.2 mm
                        </label>
                      </li>
                      <li>
                        <input id="cb17" type="checkbox" />
                        <label for="cb17" class="label-text">
                          15.6 mm
                        </label>
                      </li>
                      <li>
                        <input id="cb18" type="checkbox" />
                        <label for="cb18" class="label-text">
                          16.0 mm
                        </label>
                      </li>
                    </ul>
